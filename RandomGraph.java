...
public class RandomGraph {
    ...
    private final double PROBMEDIUM=0.3;
    private final double PROBHARD=0.3;

    private int numberVertices = VerticesEdgesInputScenes.numberOfVertices;
    private int numberEdges = VerticesEdgesInputScenes.numberOfEdges;
